...
// Source: github.com/shivshankarm/bankservice/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 db.GetTransferParams) (db.Transfers, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateEntry(arg0 context.Context, arg1 db.UpdateEntryParams) (db.Entries, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTransfer(arg0 context.Context, arg1 db.UpdateTransferParams) (db.Transfers, error) {
	m.ctrl.T.Helper()
